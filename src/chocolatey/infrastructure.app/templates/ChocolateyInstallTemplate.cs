namespace chocolatey.infrastructure.app.templates
{
    ...
    {
        public static string InstallerTemplate =
...
# see https://github.com/chocolatey/chocolatey/wiki/HelpersReference
...
#try { #error handling is only necessary if you need to do anything in addition to/instead of the main helpers
  ...
  # see the full list at https://github.com/chocolatey/chocolatey/wiki/HelpersReference

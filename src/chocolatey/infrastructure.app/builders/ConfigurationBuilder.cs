...
namespace chocolatey.infrastructure.app.builders
{
    ...
    public static class ConfigurationBuilder
    {
        ...
        private static void set_config_items(ChocolateyConfiguration config, ConfigFileSettings configFileSettings, IFileSystem fileSystem)
        {
            ...
            config.SecurityProtocols.AllowedSecurityProtocol = set_config_item(ApplicationParameters.ConfigSettings.AllowedSecurityProtocols, configFileSettings, "ssl3,tls,tls11,tls12", "A comma - separated list of secuirty protocols to be allowed in the communication to the package manager server ex.tls11, tls12, ssl3");
        }

...
namespace chocolatey.infrastructure.app.builders
{
    ...
    public static class ConfigurationBuilder
    {
        ...
        private static void SetAllFeatureFlags(ChocolateyConfiguration config, ConfigFileSettings configFileSettings)
        {
            ...
            config.Features.UsePackageHashValidation = SetFeatureFlag(ApplicationParameters.Features.UsePackageHashValidation, configFileSettings, defaultEnabled: false, description: "Use Package Hash Validation - Check the hash of the downloaded package file against the server provided hash. Only supports servers that provide SHA512 hashes. Disabled by default. Available in 2.3.0+");

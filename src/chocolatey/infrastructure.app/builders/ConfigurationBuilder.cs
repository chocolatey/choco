...
namespace chocolatey.infrastructure.app.builders
{
    ...
    public static class ConfigurationBuilder
    {
        ...
        private static void set_feature_flags(ChocolateyConfiguration config, ConfigFileSettings configFileSettings)
        {
            ...
            config.Features.AutomaticProcessElevation = set_feature_flag(ApplicationParameters.Features.AutomaticProcessElevation, configFileSettings, defaultEnabled: false, description: "Automatically elevate process if requires so.");
            ...
            ConfigurationOptions.parse_arguments_and_update_configuration(
                ...
                (option_set) =>
                {
                    option_set
                        ...
                        .Add("noelevation",
                             "Disables automatic process elevation",
                             option => config.Features.AutomaticProcessElevation = option == null)
                        ;
                },
                (unparsedArgs) =>
                {

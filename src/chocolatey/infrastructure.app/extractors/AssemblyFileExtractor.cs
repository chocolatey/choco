namespace chocolatey.infrastructure.app.extractors
{
    ...
    {
        public static void extract_file_from_assembly(IFileSystem fileSystem, Assembly assembly, string manifestLocation, string filePath, bool overwriteExisting = false)
        {

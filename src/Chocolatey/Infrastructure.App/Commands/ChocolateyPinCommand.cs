...
namespace Chocolatey.Infrastructure.App.Commands
{
    ...
    public class ChocolateyPinCommand : ICommand
    {
        ...
        public virtual void Validate(ChocolateyConfiguration configuration)
        {
            ...
            {
                throw new ApplicationException("When specifying the subcommand '{0}', you must also specify --name.".FormatWith(configuration.PinCommand.Command.ToStringChecked()));
            }
        }
...
");
        ...
        {
            this.Log().Info("Pin would have called {0} with other options:{1} Name={2}{1} Version={3}".FormatWith(configuration.PinCommand.Command.ToStringChecked(), Environment.NewLine, configuration.PinCommand.Name, configuration.Version));
        }
        ...
        public virtual void SetPin(ChocolateyConfiguration config)
        {
            ...
            this.Log().Info("Trying to {0} a pin for {1}".FormatWith(config.PinCommand.Command.ToStringChecked(), config.PinCommand.Name));

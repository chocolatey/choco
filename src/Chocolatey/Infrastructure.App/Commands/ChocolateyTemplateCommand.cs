...
namespace Chocolatey.Infrastructure.App.Commands
{
    ...
    public class ChocolateyTemplateCommand : ICommand
    {
        ...
        public virtual void Validate(ChocolateyConfiguration configuration)
        {
            ...
            {
                throw new ApplicationException("When specifying the subcommand '{0}', you must also specify --name.".FormatWith(configuration.TemplateCommand.Command.ToStringChecked()));
            }
        }

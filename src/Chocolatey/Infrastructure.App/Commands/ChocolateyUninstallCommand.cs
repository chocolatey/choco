            ...
            optionSet
                ...
                .Add("ignorepackagecodes|ignorepackageexitcodes|ignore-package-codes|ignore-package-exit-codes",
                 ...
                 .Add("autouninstaller|use-autouninstaller",
                     "UseAutoUninstaller - Use auto uninstaller service when uninstalling. Overrides the default feature '{0}' set to '{1}'. Available in 0.9.10+.".FormatWith(ApplicationParameters.Features.AutoUninstaller, configuration.Features.AutoUninstaller.ToStringChecked()),
                     option => configuration.Features.AutoUninstaller = option != null
                     )
                 .Add("skipautouninstaller|skip-autouninstaller",
                     "SkipAutoUninstaller - Skip auto uninstaller service when uninstalling. Overrides the default feature '{0}' set to '{1}'. Available in 0.9.10+.".FormatWith(ApplicationParameters.Features.AutoUninstaller, configuration.Features.AutoUninstaller.ToStringChecked()),
                     option =>
                     {
                         if (option != null)
                         {
                 ...
                 .Add("failonautouninstaller|fail-on-autouninstaller",
                     "FailOnAutoUninstaller - Fail the package uninstall if the auto uninstaller reports and error. Overrides the default feature '{0}' set to '{1}'. Available in 0.9.10+.".FormatWith(ApplicationParameters.Features.FailOnAutoUninstaller, configuration.Features.FailOnAutoUninstaller.ToStringChecked()),
                 ...
                 .Add("ignoreautouninstallerfailure|ignore-autouninstaller-failure",
                     "Ignore Auto Uninstaller Failure - Do not fail the package if auto uninstaller reports an error. Overrides the default feature '{0}' set to '{1}'. Available in 0.9.10+.".FormatWith(ApplicationParameters.Features.FailOnAutoUninstaller, configuration.Features.FailOnAutoUninstaller.ToStringChecked()),
                     option =>
                     {
                         if (option != null)
                         {

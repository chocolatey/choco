...
namespace Chocolatey.PowerShell.Helpers
{
    ...
    public static class ChecksumValidator
    {
        ...
        public static bool IsValid(PSCmdlet cmdlet, string path, string checksum, ChecksumType? checksumType, string url, out Exception error)
        {
            ...
            if (IsEqual(Environment.GetEnvironmentVariable(PackageVariables.ChocolateyIgnoreChecksums), "true"))
            {
            ...
            {
                if (IsEqual(Environment.GetEnvironmentVariable(PackageVariables.ChocolateyAllowEmptyChecksums), "true"))
                {
                ...
                if (isHttpsUrl && IsEqual(Environment.GetEnvironmentVariable(PackageVariables.ChocolateyAllowEmptyChecksumsSecure), "true"))
                {
                ...
                if (IsEqual(Environment.GetEnvironmentVariable(PackageVariables.ChocolateyPowerShellHost), "true")
                    && !(cmdlet.Host is null))
                {
